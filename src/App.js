    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={<ShortUrlPage links={links} setLinks={setLinks} />}
        />

        <Route
          path="/statistics"
          element={<Statistics links={links} onDelete={onDelete} />}
        />

        <Route
          path="/:shortCode/stat"
          element={<Stat links={links} setLinks={setLinks} />}
        />
        ...
        <Route
          path="/"
          element={<Home links={links} addUrl={addUrl} onDelete={onDelete} />}
        />
      </Routes>
    </Router>
  );
